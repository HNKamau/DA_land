...
The input data file: land_consolidation_input.csv (containing probabilistic ranges of variables)
                    : market_scenarios.csv (containing price ranges of maize and lease)
The model function: land_consolidation_function.R
The analysis report: Kamau_Whitney_2025_model_run_files.Rmd, which demonstrates how outcome decisions vary under different scenarios driven by key variables. 
Sensisitivity analysis: Kamau_2026_sensitivity_analysis.Rmd,  which varies correlation between price-related variables, discount rates, and project horizon. 
